...
function Subscription({ subscription, myPackage }) {
  // Chakra color mode
        ...
        <>
          ...
          <CardBody px="5px">
            <Flex direction="column">
              ...
              <Heading as="h3" size="lg" mb={4} color="teal">
                Explore Our Exclusive Packages
              </Heading>
              <Text fontSize="xl">
                Discover a world of savings and benefits with our curated
                packages. Unlock endless discounts tailored just for you!
              </Text>
              <Button
                size="lg"
                colorScheme="teal"
                mt="24px"
                onClick={() => {
                  history.push("./SubscribePackages");
                }}
              >
                Subscribe Now
              </Button>
